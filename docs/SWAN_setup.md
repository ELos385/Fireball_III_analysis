...
- [Set up virtual environment in SWAN which supports LAMP](#Set-up-virtual-environment-in-SWAN-which-supports-LAMP)
    ...
    - [10: Run bash script to automatically load kernel at the start of every SWAN session](#10:-Run-bash-script-to-automatically-load-kernel-at-the-start-of-every-SWAN-session)
